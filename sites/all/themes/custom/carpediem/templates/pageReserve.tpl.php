...
<div id="page-wrapper"><div id="page">
  ...
  </div></header> <!-- /.section,#header-wrapper /#header -->
  <?php if ($page['help']): ?>
      <div id="help"> <div class="section">
...
<?php } ?>
    ...
    <?php if ($page['sidebar']): ?>
      <aside id="sidebar" class="column sidebar" role="complementary"><div class="section">
        <?php print render($page['sidebar']); ?>
      </div></aside> <!-- /.section, /#sidebar -->
    <?php endif; ?>
